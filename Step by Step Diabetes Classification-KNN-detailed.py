...
# Loading the dataset
diabetes_data = pd.read_csv(r'D:\ds\kaggle\Step by Step Diabetes Classification-KNN-detailed/datasets_228_482_diabetes.csv')
...
# with nan since after that counting them would be easier and zeros need to be replaced with suitable values
...
# diabetes_data_copy.to_csv(r'D:\ds\kaggle\Step by Step Diabetes Classification-KNN-detailed/datasets_228_482_diabetes2.csv')
print('==============diabetes_data_copy.info==============')

diabetes_data_copy.info(verbose=True)
print('==============diabetes_data_copy.info==============')
